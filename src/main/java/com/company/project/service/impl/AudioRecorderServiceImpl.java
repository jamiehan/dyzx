...
@Slf4j
public class AudioRecorderServiceImpl {
//
//    private static AudioRecorderServiceImpl audioRecorder;
//    //音频输入-麦克风
//    private final static int AUDIO_INPUT = MediaRecorder.AudioSource.MIC;
//    //采用频率
//    //44100是目前的标准，但是某些设备仍然支持22050，16000，11025
//    //采样频率一般共分为22.05KHz、44.1KHz、48KHz三个等级
//    private final static int AUDIO_SAMPLE_RATE = 11025;
//    //声道 单声道
...
//
//    private AudioRecorderServiceImpl() {
//    }
//
//    //单例模式
//    public static AudioRecorderServiceImpl getInstance() {
//        if (audioRecorder == null) {
//            audioRecorder = new AudioRecorderServiceImpl();
//        }
...
//        }
//        log.info("AudioRecorder","===startRecord==="+audioRecord.getState());
...
//        log.info("AudioRecorder","===pauseRecord===");
//        if (status != Status.STATUS_START) {
...
//        log.info("AudioRecorder","===stopRecord===");
...
//     */
//    public void release() {
//        log.info("AudioRecorder","===release===");
//        //假如有暂停录音
//        try {
//            if (filesName.size() > 0) {
...
//        } catch (IllegalStateException e) {
//            log.info("AudioRecorder", e.getMessage());
//            throw new IllegalStateException(e.getMessage());
