...
//        webSocketHandlerRegistry.addHandler(new WsHandler(),"/onekeyalarm","/videostream").addInterceptors(wsIntercept).setAllowedOrigins("*");
        webSocketHandlerRegistry.addHandler(wsHandler,"/receivealarm","/onekeyalarm","/videostream","/facealarm","gatheringalarm").addInterceptors(wsIntercept).setAllowedOrigins("*");
    }
