    ...
    class PCMPlayer {
        ...
        init(option) {
            const defaultOption = {
                ...
                inputCodec: 'Int8', // 传入的数据是采用多少位编码，默认16位
                channels: 1, // 声道数
                sampleRate: 11025, // 8000采样率 单位Hz
        ...
        feed(data) {
            ...
            const tmp = new Int8Array(this.samples.length + data.length);
        ...
        getFormatedValue(data) {
            ...
            let int8Array = new Int8Array(data.length);
            console.log("int8Array>>>>",int8Array,data.length);
            ...
            for (let i = 0; i < data.length; i++) {
                ...
                int8Array[i] = data[i] / this.convertValue;
            }
            // return float32
            return int8Array
        }
